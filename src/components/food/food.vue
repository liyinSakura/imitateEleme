    ...
    <div class="food" v-show="showFlag" ref="food">
      <div class="food-content">
        ...
        <div class="rating">
          ...
          <ratingselect :select-type="selectType" :only-content="onlyContent" :desc="desc" :ratings="food.ratings" v-on:rating="handler" v-on:content="toggle"></ratingselect>
            ...
            <ul v-show="food.ratings && food.ratings.length">
              <li v-show="needShow(rating.rateType,rating.text)" class="rating-item border-1px" v-for="rating in food.ratings">
                <div class="user">
                  ...
                  <img :src="rating.avatar" alt="" width="12" class="avatar" height="12">
                </div>
  ...
  export default {
    ...
    methods: {
      ...
      show () {
        ...
        this.$nextTick(() => {
          if (!this.scoll) {
            this.scoll = new BScorll(this.$refs.food, {
              click: true
            });
          } else {
            this.scoll.refresh();
